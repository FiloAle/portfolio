...
export function Navbar() {
  return (
    <div className="w-full max-w-xl sm:px-0 px-6 max-sm:mt-6 mt-10 tracking-tight fixed top-0 z-50">
      <div className="w-full h-full backdrop-blur-2xl rounded-full flex flex-row items-center justify-center">
        <nav
          className="w-full xs:max-sm:w-max px-3.5 py-3.5 sm:py-3 rounded-full border border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-800 opacity-80 shadow-lg dark:shadow-2xl"
          id="nav"
        >
